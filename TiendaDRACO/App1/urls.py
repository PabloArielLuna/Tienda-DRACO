...
urlpatterns = [
    ...
    path('buscar_email_usuario/', views.buscar_usuario, name='Buscar usuario'),
    ...
    path('actualizar_usuarios/<usuarios_id>', views.actualizar_usuarios, name='Actualizar usuarios'),
    path('eliminar_ventas_detalles/<ventas_detalles_id>', views.eliminar_Ventas_detalles, name='Eliminar Ventas_detalles'),
